...
const stories = [
  {
    id: 1,
    content: (
      <div className="p-6 h-full flex flex-col items-center justify-center space-y-4 bg-gradient-to-br from-purple-500 to-pink-500 text-white">
  ...
  },
  {
    id: 2,
    content: (
      <div className="p-6 h-full flex flex-col space-y-4 bg-gradient-to-br from-blue-500 to-cyan-500 text-white">
  ...
  },
  {
    id: 3,
    content: (
      <div className="p-6 h-full flex flex-col space-y-4 bg-gradient-to-br from-green-500 to-teal-500 text-white">
  ...
  },
  {
    id: 4,
    content: (
      <div className="p-6 h-full flex flex-col items-center justify-center space-y-4 bg-gradient-to-br from-orange-500 to-red-500 text-white">
